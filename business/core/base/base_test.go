...
func Test_Calcli(t *testing.T) {
	...
	core := base.NewCore(logger.New(os.Stdout, logger.LevelInfo, "TEST", func(ctx context.Context) string { return "" }))
...
func testSum(ctx context.Context, core *base.Core) func(t *testing.T) {
...
func testMultiply(ctx context.Context, core *base.Core) func(t *testing.T) {
	return func(t *testing.T) {
		input1 := "2*2*2,3*3*3"
		total1 := float64(35)
...
func testDivition(ctx context.Context, core *base.Core) func(t *testing.T) {
	return func(t *testing.T) {
		input1 := "10/5/2,8/2/2"
		total1 := float64(3)
...
func testMix(ctx context.Context, core *base.Core) func(t *testing.T) {
	return func(t *testing.T) {
		input1 := "10/5/2*4+2"
		total1 := float64(6)
